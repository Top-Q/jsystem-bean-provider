...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * d.initTreeTableModel(objInstance); d.showDialog();
		 * 
		 * System.out.println((((AbstractBeanTreeNode)
		 * (d.treeTableModel.getRoot())).getUserObject()));
		 * 
		 * if(d.isSaveClicked()) { Object obj = d.getRootObject();
		 * d.initTreeTableModel(obj); } else { Object obj = xs.fromXML(strObj);
		 * d.initTreeTableModel(obj); } d.showDialog();
		 */
	...
	private static Library createLibrary() {
		...
		b0.setFile(new File(
				"/workspace/dev/git3/jsystem-bean-provider/bean-tree-provider/src/main/java/org/jsystemtest/Main.java"));
		// b0.setPages(4);
